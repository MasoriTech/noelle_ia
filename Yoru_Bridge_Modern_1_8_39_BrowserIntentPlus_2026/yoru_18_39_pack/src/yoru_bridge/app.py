...
class YoruApp:
    ...
    def print_status(self):
        ...
        print('Digite /ajuda, /baixar status, /skills status, /contratos status, /apps favoritos, /avatar status ou /sair.\n')
...
def main():
    mode = 'text'
    if len(sys.argv) > 1 and sys.argv[1] in {'text','voice','stream'}:
        mode = sys.argv[1]
