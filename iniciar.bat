...
cls
echo ================================================================
echo  Noelle/Yoru Companion 2026 - V19.8.32 Segment Recorder
echo ================================================================
echo.
echo  [1] Iniciar programa agora
echo  [2] Aplicar V19.8.32 Segment Recorder
echo  [3] Rodar diagnostico V19.8.32
...
if "%OP%"=="2" goto AUTO_32
if "%OP%"=="3" goto DIAG_32
...
call :CHECK_NODE
if errorlevel 1 pause & goto MENU
node scripts\apply_v19_8_32_auto_2026.cjs
pause
goto MENU
...
call :CHECK_NODE
if errorlevel 1 pause & goto MENU
node scripts\diagnostico_v19_8_32_stream_segment_recorder_2026.cjs
pause
goto MENU
...
set MSG=V19.8.32 grava trechos de audio da Stream em memoria
