...
console.log("Avatar V41 Checkup");
console.log("==================");
...
[
  ...
  "src/assets/model_manifest_v41.json"
].forEach((file) => {
...
[
  ...
  "scripts/selftest_avatar_v41.js"
].forEach((file) => {
...
if (controls) {
  const count = (controls.match(/<script[^>]*avatar_page_owner_v41\.js[^>]*><\/script>/g) || []).length;
  console.log("");
  console.log(count === 1 ? "[OK] owner v41 ativo uma vez" : "[WARN] owner v41 ocorrências: " + count);
