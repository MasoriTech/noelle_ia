...
run("Aplicando V19.8.32", ["scripts/repair_v19_8_32_stream_segment_recorder_2026.cjs"]);
run("Rodando diagnóstico V19.8.32", ["scripts/diagnostico_v19_8_32_stream_segment_recorder_2026.cjs"]);
...
console.log("[OK] V19.8.32 aplicado e diagnosticado.");
