...
run("Aplicando V19.8.27b", ["scripts/repair_v19_8_27b_controls_syntax_fix_2026.cjs"]);
run("Rodando diagnóstico V19.8.27b", ["scripts/diagnostico_v19_8_27b_controls_syntax_fix_2026.cjs"]);
...
console.log("[OK] V19.8.27b aplicado e diagnosticado.");
