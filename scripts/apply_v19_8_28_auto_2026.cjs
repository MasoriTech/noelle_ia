...
run("Aplicando V19.8.28", ["scripts/repair_v19_8_28_status_assets_split_2026.cjs"]);
run("Rodando diagnóstico V19.8.28", ["scripts/diagnostico_v19_8_28_status_assets_split_2026.cjs"]);
...
console.log("[OK] V19.8.28 aplicado e diagnosticado.");
