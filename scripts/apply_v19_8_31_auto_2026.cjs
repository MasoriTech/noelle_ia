...
run("Aplicando V19.8.31", ["scripts/repair_v19_8_31_stream_vad_simple_2026.cjs"]);
run("Rodando diagnóstico V19.8.31", ["scripts/diagnostico_v19_8_31_stream_vad_simple_2026.cjs"]);
...
console.log("[OK] V19.8.31 aplicado e diagnosticado.");
