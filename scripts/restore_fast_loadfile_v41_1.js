...
function log(msg) {
  console.log("[restore-loadfile-v41.1] " + msg);
}
...
const restoreBackup = app + ".bak_restore_v41_1";
...
log("nenhum backup limpo encontrado; mantendo arquivo atual. O owner v41.1 ainda abre Loadfile sem query.");