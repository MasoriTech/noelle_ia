...
const BRIDGE = path.join(ROOT, "src", "main", "stream_stt_bridge_v19_8_39.cjs");

function log(msg) { console.log("[stream-v19.8.39-main] " + msg); }
...
const backup = MAIN + ".bak_stream_v19_8_39";
...
if (!source.includes("NOELLE_STREAM_STT_MAIN_V19_8_39_BEGIN")) {
  source += "\n\n" + fs.readFileSync(BRIDGE, "utf8") + "\n";
  fs.writeFileSync(MAIN, source, "utf8");
  log("bridge STT v39 adicionada ao main.js");
} else {
  log("bridge STT v39 já estava no main.js");
}
